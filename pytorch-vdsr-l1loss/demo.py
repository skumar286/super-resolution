...
parser.add_argument("--model", default="/media/DiskE/vdsr2x4x/pytorch-vdsr-l1loss/checkpoint/model_epoch_50.pth", type=str, help="model path")
...
for dt in range(len(data_hr)):
	...
	c=data_hr[dt].split('/')
	c=c[-1].split(".")[0]
	im_h.save("/media/DiskE/vdsr2x4x/pytorch-vdsr-l1loss/Urban100gen/"+c+ "_gn"+str(opt.scale)+".png")
