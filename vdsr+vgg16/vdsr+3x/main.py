...
python main.py --test_only True --gpu 1 --chk 164 --scale 2 --test_image some.png
...
parser.add_argument('--scale', action='store' , dest = 'scale' , default = 3)
