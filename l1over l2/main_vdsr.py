...
parser.add_argument("--resume", default="checkpoint/model_epoch_21.pth", type=str, help="Path to checkpoint (default: none)")
...
def main():
    ...
    for epoch in range(opt.start_epoch, opt.nEpochs + 1):
        if epoch <= 25:
            ...
            train(training_data_loader, optimizer, model, criterion2, epoch)
            save_checkpoint(model, epoch)
