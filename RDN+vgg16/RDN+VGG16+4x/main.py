...
class PERCEPTUAL_RDN:
   ...
   #  def gram_matrix(activation):
    ...
    def fit(self , X , Y ,batch_size=16 , epoch = 1000 ):
            ...
            hist = self.loss_model.fit(x = {'rdn_input':X,'vgg_net_input':Y}, y = {'l1_output':Y , 'content_loss':zero , 'style_loss':zero} , batch_size = batch_size ,validation_split=0.3, verbose =1 , nb_epoch=epoch)
            return hist.history
